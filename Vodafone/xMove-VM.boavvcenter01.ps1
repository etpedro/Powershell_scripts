...
$vmname = "boavvcenter01"
$sourceVC = "sun.mgmt.pt"
$sourceVCUsername = "administrator@mgmt.pt"
$sourceVCPassword = "0ss@cl0ud"
$destVC = "sun01.mgmt.pt"
$destVCUsername = "administrator@vsphere.local"
$destVCpassword = "0ss@cl0ud"
$datastorename = "VMBoaMGMT201"
$clustername = "MGMT"
$vmhostname = "bunda.mgmt.pt"
$vmnetworkname = "DvPG-MGMT_Mgmt_Ephemeral"
$switchname = "DSwitch-MGMT"
$switchtype = "vds"
